...
function mt_settings() {
	...
	foreach ( $post_types as $type ) {
		...
		$mt_post_type_options .= "<option value='$type->name'$selected>" . $type->labels->name . "</option>";
	}
					...
					<div class="postbox">
						...
						<div class="inside">
							<form method="post" action="<?php echo admin_url( "admin.php?page=my-tickets" ); ?>">
											...
											<div class='wptab mt_<?php echo $type; ?>' id='<?php echo $type; ?>'
												...
												<fieldset>
													...
													<ul>
														<li>
															<label
																for="mt_messages_<?php echo $type; ?>_admin_subject"><?php printf( __( '%s - Subject', 'my-tickets' ), $status_type ); ?></label><br/>
															<input type="text"
														...
														<li>
															<label
																for="mt_messages_<?php echo $type; ?>_admin_body"><?php printf( __( '%s - Message', 'my-tickets' ), $status_type ); ?></label><br/><textarea
												...
												<fieldset>
													...
													<ul>
														<li>
															<label
																for="mt_messages_<?php echo $type; ?>_purchaser_subject"><?php printf( __( '%s - Subject', 'my-tickets' ), $status_type ); ?></label><br/>
															<input type="text"
														...
														<li>
															<label
																for="mt_messages_<?php echo $type; ?>_purchaser_body"><?php printf( __( '%s - Message', 'my-tickets' ), $status_type ); ?></label><br/><textarea
								...
								<p>
									<label
										for='post_types'><?php _e( 'Enable ticketing for these post types:', 'my-tickets' ); ?></label>
									<select multiple='multiple' name='mt_post_types[]' id='post_types'>
...
function mt_wp_enqueue_scripts() {
	...
	if ( $current_screen->base == 'post' && in_array( $current_screen->id, $options['mt_post_types'] ) ) {
		wp_enqueue_script( 'mt.add', plugins_url( 'js/jquery.addfields.js', __FILE__ ), array( 'jquery' ) );
